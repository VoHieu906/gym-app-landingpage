...
<SectionWrapper id="faqs">
  ...
  >
    <div class="flex flex-col gap-2">
      ...
      <h3
        class="text-4xl sm:text-5xl md:text-6xl max-w-[62.5rem] mx-auto w-full font-semibold text-center"
      >
    ...
    <div class="flex flex-col gap-8 sm:gap-10 md:gap-14 w-full">
      {#each faqs as faq}
        <div
          class="flex flex-col gap-2 text-left max-w-[50rem] w-full mx-auto relative p-4 px-6"
        >
          <div
